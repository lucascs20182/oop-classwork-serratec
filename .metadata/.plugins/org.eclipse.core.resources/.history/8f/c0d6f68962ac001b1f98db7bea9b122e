...
public class Programa {
	...
	public static void main(String[] args) throws CpfRepetidoException, DependenteException {
		...
		Dependente[] dependentesDoLucas = { dependente1, dependente2 };
		 
		Funcionario funcionario1 = new Funcionario("Lucas Cruz", "12345678990", LocalDate.of(1997, 06, 26), 7000, dependentesDoLucas);
